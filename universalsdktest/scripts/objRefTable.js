...
self.C3_GetObjectRefTable = function () {
	return [
		...
		C3.JavaScriptInEvents.списоксобытий1_Event37_Act2,
		C3.JavaScriptInEvents.списоксобытий1_Event39_Act2,
		C3.JavaScriptInEvents.списоксобытий1_Event39_Act3,
		C3.JavaScriptInEvents.списоксобытий1_Event39_Act5,
...
self.InstanceType = {
	...
	debugArea: class extends self.ITextInputInstance {}
}