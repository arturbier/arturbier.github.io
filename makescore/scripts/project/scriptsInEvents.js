...
const scriptsInEvents = {
		...
		async Achievements_Event15_Act1(runtime, localVars)
		{
		...
		async Achievements_Event16_Act1(runtime, localVars)
		{
			var count = 200;
			var defaults = {
			  origin: { y: 0.7 }
		...
		async Achievements_Event17_Act1(runtime, localVars)
		{
		...
		async Achievements_Event18_Act1(runtime, localVars)
		{
			var duration = 15 * 1000;
			var animationEnd = Date.now() + duration;
			var skew = 1;
		...
		async Achievements_Event20_Act1(runtime, localVars)
		{
