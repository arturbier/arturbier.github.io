...
self.C3_GetObjectRefTable = function () {
	return [
		...
		C3.Plugins.PlaygamaBridge.Acts.LeaderboardsSetScore,
		C3.Plugins.PlaygamaBridge.Exps.PlayerId,
		C3.Plugins.Sparsha_FirebaseAuth.Cnds.IsSignedIn,
		C3.Plugins.System.Cnds.Else,
		C3.Plugins.Sparsha_FirebaseAuthExtended.Acts.AnonymousAuth,
		C3.Plugins.Sparsha_FirebaseAuthExtended.Cnds.OnSignedIn,
		C3.Plugins.Text.Acts.SetText,
		C3.Plugins.Sparsha_FirebaseAuth.Exps.userID,
		C3.Plugins.PlaygamaBridge.Cnds.OnLeaderboardsSetScoreCompleted,
		C3.Plugins.Browser.Acts.Alert,
		C3.Plugins.PlaygamaBridge.Exps.LeaderboardEntryScore,
		C3.Plugins.PlaygamaBridge.Acts.LeaderboardsShowNativePopup,
